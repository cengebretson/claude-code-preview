...
Mouse click selects a file; scroll wheel moves the diff pane. `enter` opens the file in a tmux popup by default — set `popup_editor: false` in config to open in the pane instead.
